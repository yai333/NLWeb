# --- START OF FILE load_shopify_products_to_nlweb.py ---
...
# Improved pattern to handle various disclaimer formats
...
def get_all_shopify_products(shop_url, access_token, api_version):
    ...
    try:
        ...
        # Fetch products with only necessary fields to reduce payload
...
def clean_description(html_content):
    """Clean product description from unwanted patterns"""
    if not html_content:
        return ""

    # Remove all disclaimer patterns
